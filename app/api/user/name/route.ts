...
export async function PUT(request: NextRequest) {
  ...
  wideEvent.setRequest({ method: 'PUT', path: '/api/user/name' });
  ...
  try {
    ...
    wideEvent.setCustom('new_name_length', name.length);
    ...
    wideEvent.setCustom('operation_type', 'name_update');
    ...
    wideEvent.setError({ type: error instanceof Error ? error.name : 'UnknownError', message: error instanceof Error ? error.message : 'Internal server error', code: 'name_update_error' });
    wideEvent.setCustom('latency_ms', duration);
