  ...
  return (
    <div className="flex flex-1 min-h-[60vh] items-center justify-center">
      <div className="flex flex-col items-center justify-center text-center">
        <h1 className="text-2xl font-bold mb-4">Chat Temporarily Unavailable</h1>
        <p className="text-lg text-muted-foreground mb-6">We're updating our AI features. Check back soon.</p>
        <a
          href="/"
