        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="w-24 h-24 mx-auto mb-4 flex items-center justify-center bg-transparent">
              <Image src="/favicon180.png" alt="Tekir Profile" width={128} height={128} className="w-full h-full object-contain" />
            </div>
          ...
          <section className="mb-8">
            <h2 className="text-lg font-semibold mb-4 text-center text-primary">TRY SEARCH NOW</h2>
            <Link
              href="/"
              className={
                buttonVariants({ variant: "default", size: "lg" }) +
                " w-full justify-between group hover:scale-[1.02] transition-transform shadow-lg h-16"
              }
            >
              <div className="flex items-center gap-3">
