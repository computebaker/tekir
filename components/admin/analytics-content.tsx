...
export function AnalyticsContent() {
  ...
  const fromDay = useMemo(() => {
    ...
    if (range === "7d") return dayNDaysAgo(6);
  ...
  const exportCsv = () => {
    ...
    const csv = ["day,searches,ai_requests,api_hits", ...rows].join("\n");
                ...
                {([
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-md text-sm ${
                      range === opt.k ? "bg-primary text-primary-foreground" : "hover:bg-muted"
                    }`}
                  >
                    {opt.label}
                  </button>
              ...
              {providers.length > 0 && (
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <button onClick={() => setProviderFilter(null)} className="px-2 py-1 rounded border text-xs hover:bg-muted">
                      All
                    </button>
                  </div>
                </div>
              ...
              {types.length > 0 && (
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <button onClick={() => setTypeFilter(null)} className="px-2 py-1 rounded border text-xs hover:bg-muted">
                      All
                    </button>
                  </div>
                </div>
            ...
            <div className="text-sm space-y-1">
              {(displayTopQueries || []).map((t: any) => (
                <div key={t.query} className="flex items-center justify-between">
                  <span className="truncate max-w-[75%]" title={t.query}>
                    {t.query}
                  </span>
